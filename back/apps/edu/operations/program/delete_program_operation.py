...
from apps.docs.opertaions.program_order.delete_program_order_operation import DeleteProgramOrderOperation
from apps.edu.operations.program.base_program_operation import BaseProgramOperation
