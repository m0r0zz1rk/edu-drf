...
from apps.edu.consts.student_group_forms import STUDENT_GROUP_FORMS, WITHOUT
from apps.edu.consts.student_group_statuses import STUDENT_GROUP_STATUSES, REGISTRATION
