...
from apps.edu.serializers.calendar_chart_serializers import CalendarChartGetSerializer, CalendarChartUpdateSerializer
from apps.edu.utils.calendar_chart import CalendarChartUtils
