...
from apps.edu.operations.services.education_service.add_update import AddUpdateEducationService
from apps.edu.operations.services.education_service.delete import DeleteEducationService
...
class EducationServiceViewSet(viewsets.ModelViewSet):
    ...
    def create_update(self, request, *args, **kwargs):
        ...
        if serialize.is_valid():
            process = AddUpdateEducationService({
