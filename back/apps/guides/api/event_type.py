...
class EventTypeViewSet(GuideViewSet):
    ...
    base_serializer = EventTypeBaseSerializer
    create_serializer = EventTypeBaseSerializer
    update_serializer = EventTypeListUpdateSerializer
    filterset_class = NameFieldFilter
    swagger_object_name = 'Тип мероприятий'
