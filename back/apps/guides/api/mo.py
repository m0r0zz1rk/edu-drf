...
from apps.guides.selectors.mo import mo_queryset, mo_orm
...
class MoViewSet(GuideViewSet):
    orm = mo_orm
    queryset = mo_queryset()
    serializer_class = MoListUpdateSerializer
    base_serializer = MoBaseSerializer
    create_serializer = MoBaseSerializer
    update_serializer = MoListUpdateSerializer
    filterset_class = NameFieldFilter
    swagger_object_name = 'МО'
