    ...
    <template v-slot:text>
      <p>
        <i style="font-size: 12px">Внимательно ознакомьтесь с текстом настоящего Согласия, после чего примите
          ...
          квалификаций педагогов и мониторинга качества образования» согласия на рассылку Вам информации о
          предстоящих курсах и семинарах (далее – информационная рассылка). Согласием с Вашей стороны на получение
        ...
        проинформирую об этом Оператора.<br/>
